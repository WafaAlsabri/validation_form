  ...
  <?php } ?>
    ...
    <form action="add_user" method="post">
      ...
      <div class="mb-3">
        ...
        <input type="password" value="<?= empty($data['form_values']['retype_password'])?"":$data['form_values']['retype_password'] ?> " class="form-control" id="exampleInputPassword2" name="retype_password">
      </div>
